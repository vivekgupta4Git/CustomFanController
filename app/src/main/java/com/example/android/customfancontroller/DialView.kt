...
private const val RADIUS_OFFSET_LABEL = 22
        ...
        attrs : AttributeSet?=null,
               defStyleAttr: Int = 0
               ) : View(context,attrs,defStyleAttr)
                {
                    ...
                    //position variable for draw label and indicator circle
                    ...
                    override fun onDraw(canvas: Canvas?) {
                        ...
                        FanSpeed.HIGH -> fanSpeedMaxColor
                            ...
                            /*if(fanSpeed== FanSpeed.OFF) Color.GRAY
